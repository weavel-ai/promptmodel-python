...
from promptmodel.websocket.websocket_client import DevWebsocketClient, CodeReloadHandler
...
def dev():
    ...
    promptmodel_client_filename, client_instance_name = "promptmodel_dev:app".split(":")
    ...
    client_module = importlib.import_module(promptmodel_client_filename)
    ...
    dev_websocket_client = DevWebsocketClient(promptmodel_client=client_instance)
    
    import threading
    reloader_thread = threading.Thread(
        target=start_code_reloader, 
        args=(
            promptmodel_client_filename,
